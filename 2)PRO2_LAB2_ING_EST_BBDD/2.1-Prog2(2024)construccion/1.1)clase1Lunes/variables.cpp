...
///VARIABLE PUNTERO: variable que almacena una direcci�n de memoria
using namespace std;

///prototiopos/declaracion de funciones
...
int main(){ 
    int vec[5]={}, *puntV;///siempre que vea al momento de la declaraci�n un * antes del
