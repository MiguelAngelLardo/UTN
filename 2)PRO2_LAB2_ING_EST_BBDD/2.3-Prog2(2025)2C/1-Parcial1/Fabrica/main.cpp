...
int main()
{
    ...
    /*
    El método EjemploDeListado muestra cómo se puede generar un listado de los registros a partir de los datos del archivo.
    Se recomienda tomarlo de ejemplo para la resolución de los demás puntos.
