...
int main()
{
  ...
  int vNumFive[VECT_1] = {}, vNumTen[VECT_2] = {}, vNumUnion[VECT_1+VECT_2] = {}, n;
  ...
  for(int x = 0; x < VECT_1+VECT_2; x ++){
    if(x < VECT_1)
      vNumUnion[x] = vNumFive[x];
    else if(x < VECT_1+VECT_2)
      vNumUnion[x] = vNumTen[x - VECT_1];
  }

  cout << endl << "OUT THIRD  VECTOR: " << endl;
  for(int x = 0; x < VECT_1+VECT_2; x ++)
    cout << "Number #" << x+1 << ": " << vNumUnion[x] << endl; 
