...
<body>
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td class="style5">
                <asp:RequiredFieldValidator ID="rfvTipoEnvio" runat="server" ControlToValidate="rblTipoEnvio" ErrorMessage="Elija un tipo de envío">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="style5">
                 <asp:CompareValidator ID="cvPaquetes" runat="server" Operator="GreaterThan" Type="Integer" ValueToCompare="0" ControlToValidate="txtPaquetes" ErrorMessage="Cantidad de paquetes inválidos">*</asp:CompareValidator>
&nbsp;&nbsp;&nbsp;&nbsp;
                <br />
                <asp:RequiredFieldValidator ID="rfvPaquetes" runat="server" ControlToValidate="txtPaquetes" ErrorMessage="No se ha ingresado una cantidad de paquetes">*</asp:RequiredFieldValidator>
                <br />
            </td>
        </tr>
        <tr>
            ...
            <td class="style5">
                <asp:RegularExpressionValidator ID="revTelefono" runat="server" ControlToValidate="txtTelefono" ValidationExpression="^[0-9$]*$" ErrorMessage="Número de telefono inválido">*</asp:RegularExpressionValidator>
                <br />
