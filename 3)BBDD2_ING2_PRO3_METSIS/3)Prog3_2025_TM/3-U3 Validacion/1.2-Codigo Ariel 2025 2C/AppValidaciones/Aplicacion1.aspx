...
<body>
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="rfvEmpresa" runat="server" ControlToValidate="ddlEmpresa" InitialValue="0">Seleccione una empresa</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="auto-style4">
            ...
            <td>
                <asp:RequiredFieldValidator ID="rfvTipoEnvio" runat="server" ControlToValidate="rblTipoEnvio">Elija un tipo de envío</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="auto-style4">
            ...
            <td>
                <asp:RequiredFieldValidator ID="rfvComentario" runat="server" ControlToValidate="txtComentarios">Ingrese un comentario</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="auto-style4">
