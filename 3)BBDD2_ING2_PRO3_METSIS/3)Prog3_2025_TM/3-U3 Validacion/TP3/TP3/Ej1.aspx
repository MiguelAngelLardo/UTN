    ...
    <form id="form1" runat="server">
        <table class="auto-style1">
          ...
          <tr>
            ...
            <td>
                <asp:CustomValidator ID="cvRepetido" runat="server" ControlToValidate="txtLocalidad" OnServerValidate="cvRepetido_ServerValidate" ValidationGroup="G1">Ya existe Localidad</asp:CustomValidator>
              </td>
          </tr>
          <tr>
            <td class="auto-style3">&nbsp;</td>
