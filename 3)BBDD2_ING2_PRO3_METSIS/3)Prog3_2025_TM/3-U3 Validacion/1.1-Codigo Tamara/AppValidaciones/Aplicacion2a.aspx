...
<body>
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td class="style5">
                <asp:CompareValidator ID="cvPaquetes" runat="server" ControlToValidate="txtPaquetes" Operator="GreaterThan" Type="Integer" ValueToCompare="0">Ingreso un paquete invalido</asp:CompareValidator>
            </td>
        </tr>
        <tr>
            <td class="style3">
