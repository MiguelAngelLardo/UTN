            ...
            <td>
                ...
                <table class="style1">
                    <tr>
                        ...
                        <td>
                            <asp:RegularExpressionValidator ID="revNumeros" runat="server" ControlToValidate="txtNumeros" ValidationExpression="^\d+$">Error, solo ingrese números</asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
