<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Aplicacion2.aspx.cs" Inherits="Video7.Aplicacion2" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:ListView ID="lvPersonas" runat="server" DataKeyNames="Dni" DataSourceID="SqlDataSource1" GroupItemCount="2">
                <AlternatingItemTemplate>
                    <td runat="server" style="background-color: #FFFFFF; color: #284775;">Dni:
                        ...
                        <br />
                        <asp:ImageButton ID="ImageButton1" runat="server" Height="150px" ImageUrl='<%# Eval("ImagenURL") %>' Width="150px" />
                        <br /></td>
                </AlternatingItemTemplate>
                <EditItemTemplate>
...
<td runat="server" />
                ...
                <ItemTemplate>
                    <td runat="server" style="background-color: #E0FFFF;color: #333333;">Dni:
                        ...
                        <br />Sexo:
                        <asp:Label ID="SexoLabel" runat="server" Text='<%# Eval("Sexo") %>' />
                        <br />&nbsp;<asp:ImageButton ID="ImageButton1" runat="server" Height="150px" ImageUrl='<%# Eval("ImagenURL") %>' Width="150px" />
                        <br /></td>
                </ItemTemplate>
                <LayoutTemplate>
                    <table runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EmpresaConnectionString %>" SelectCommand="SELECT [Dni], [Apellido], [Nombre], [Edad], [Sexo], [ImagenURL] FROM [Personas]"></asp:SqlDataSource>
        <br />
        <br />
        <br />
    </form>
