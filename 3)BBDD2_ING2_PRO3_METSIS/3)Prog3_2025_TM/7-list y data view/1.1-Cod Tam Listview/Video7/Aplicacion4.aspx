<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Aplicacion4.aspx.cs" Inherits="Video7.Aplicacion4" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:ListView ID="lvPersonas" runat="server" DataKeyNames="Dni" DataSourceID="SqlDataSource1" GroupItemCount="3">
...
<td runat="server" />
            ...
            <br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EmpresaConnectionString %>" SelectCommand="SELECT [Dni], [Nombre], [Apellido], [Edad], [Sexo], [ImagenURL] FROM [Personas]"></asp:SqlDataSource>
            <br />
            <asp:Button ID="btnMostrar" runat="server" OnClick="btnMostrar_Click" Text="Mostrar selecciones" />
            <br />
            <br />
