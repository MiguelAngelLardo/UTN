        ...
        <div>
            <table class="auto-style1">
                <tr>
                    ...
                    <td>
                        <asp:HyperLink ID="hlMostrarSucuSeleccionadas" runat="server" NavigateUrl="~/ListadoSucursalesSeleccionadas.aspx">Mostrar sucursales seleccionadas</asp:HyperLink>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style2" style="font-size: x-large"><strong>
                        <br />
