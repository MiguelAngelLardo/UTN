            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td class="auto-style3">
                        <asp:HyperLink ID="hlListadoSucu" runat="server" ForeColor="#0066FF" NavigateUrl="~/ListarSucursal.aspx" style="text-decoration: underline">Listado de sucursales</asp:HyperLink>
                    </td>
                    <td>
