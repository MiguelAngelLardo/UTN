...
void body() {
    ...
    string menuTexto = "12345678911\n - JUGAR\n - ESTADI\n - CREDITOS\n - SALIR\n";
    int anchoMax = anchoMaxletras(menuTexto); //+ 4; // Asegurarse de que el ancho sea suficiente
    int altoMax = altoMaxFilas(menuTexto); //+ 3; // Ajustar la altura para incluir todas las filas
