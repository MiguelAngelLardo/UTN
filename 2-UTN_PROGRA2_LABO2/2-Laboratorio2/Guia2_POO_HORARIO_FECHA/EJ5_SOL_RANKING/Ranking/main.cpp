	...
	do
	{
		...
		switch(opcion)
		{
			case 1: 
				...
				ranking.agregar(Pelicula("Matrix", Fecha(10, 6, 1999), 4));
				ranking.agregar(Pelicula("Indie Game", Fecha(10, 1, 2012), 4));
				ranking.agregar(Pelicula("Hackers", Fecha(15, 9, 1995), 3));
			break;
			case 2:
				cout << "PUNTUAR PELICULA" << endl;
			break;
			case 3:
				cout << "VER RANKING" << endl;
				ranking.mostrar();
			break;
			case 0:
				cout << "SALIR" << endl;
