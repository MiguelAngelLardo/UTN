...
public class ListViewDiaHorarioAdapter extends ArrayAdapter<DiaHorario> {

    private final List<DiaHorario> items;

    public ListViewDiaHorarioAdapter(@NonNull Context context, @NonNull List<DiaHorario> items) {
    ...
    private View createItemView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(getContext())
                    .inflate(R.layout.listview_item_template, parent, false);
        }
