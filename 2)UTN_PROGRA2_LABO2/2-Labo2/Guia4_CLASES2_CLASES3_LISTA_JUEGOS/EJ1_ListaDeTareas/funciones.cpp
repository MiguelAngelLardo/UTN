...
ListaDeTareas hardcodearTareas(){
   ...
   ListaDeTareas lista;
   lista.agregar(Tarea(1, "Arañar cortinas", Fecha(23, 4, 2023), 2));
   lista.agregar(Tarea(2, "Maullar", Fecha(3, 5, 2023), 1));
   lista.agregar(Tarea(3, "Dormir todo el día", Fecha(13, 5, 2023), 1));
   ...
   lista.agregar(Tarea(7, "Comer atún", Fecha(27, 4, 2023), 1));
