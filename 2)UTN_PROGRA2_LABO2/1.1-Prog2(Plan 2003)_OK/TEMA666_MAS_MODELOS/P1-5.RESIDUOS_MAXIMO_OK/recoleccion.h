...
void Residuo::Cargar() {
    ...
    cin >> _cantidadKilos;
    cout << "Ingrese el codigo de centro de recepcion: ";
...
void Residuo::Mostrar() {
    ...
    cout << "Codigo de centro de recepcion: " << _codigoCentroRecepcion << endl;
    cout << endl;
}
...
void crearArchivo(int tam=5){
    ...
    objE.Cargar();
    cout<<endl;
    fwrite(&objE, sizeof(Residuo), 1, p);
    }
...
void Centro::Mostrar() {
    cout << "Codigo de centro de recepcion: " << _codigoCentro << endl;
...
public:
    void Cargar(){
        ...
        cin >> _codigoCamion;
        cout << "Codigo de centro de recepcion: ";
        cin >> _codigoCentro;
        cout << "Ingrese Nombre: ";
        cargarCadena(_nombre,19);
