...
public:
    ...
    void MostrarLineal(){cout<<codigoObra<<";"<<direccion<<";"<<provincia<<";"<<superficie<<";"<<estadoEjecucion<<";"<<activo;}
...
public:
    ...
    void MostrarLineal(){cout<<codigoMaterial<<";"<<tipo<<";"<<nombre<<";"<<marca<<";"<<pu<<";"<<activo;}
...
public:
    ...
    void MostrarLineal(){cout<<numeroCompra<<";"<<numeroProveedor<<";"<<codigoMaterial<<";"<<codigoObra<<";"<<cantidad<<";"<<importe<<";"<<fechaCompra.getDia()<<"/"<<fechaCompra.getMes()<<"/"<<fechaCompra.getAnio()<<";"<<activo;}
...
public:
    ...
    void MostrarLineal(){cout<<numeroProveedor<<";"<<nombre<<";"<<telefono<<";"<<direccion<<";"<<provincia<<";"<<activo;}
